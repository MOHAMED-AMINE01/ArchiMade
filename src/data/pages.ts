// Content source of truth for the dedicated service + location pages.
// Every page below has genuinely unique copy (no template-swap duplication):
// service pages describe that service's real scope/process, location pages are
// anchored on the ACTUAL realisation(s) in that commune. Hard rules enforced
// here and by scripts/seo-check.mjs: zero "architecture", zero "architecte"
// (the home FAQ already captures that intent), zero em/en dashes.
...
export interface DedicatedPage {
  slug: string; // route path, begins with "/"
  kind: "service" | "location";
  crumb: string; // short label for the last breadcrumb node
  trail: Crumb[]; // mid breadcrumb nodes (template prepends Accueil, appends self)
  eyebrow: string;
  h1: string;
  title: string; // <title>
  ...
  faq: FaqItem[];
  related: string[]; // related slugs (2-3)
...
export const SERVICE_PAGES: DedicatedPage[] = [
  {
    ...
    related: ["/declaration-prealable", "/plans-techniques", TOURS_HUB],
  ...
  },
  {
    ...
    related: ["/permis-de-construire", "/accompagnement-projet-habitat", DEPT_HUB],
...
export const LOCATION_PAGES: DedicatedPage[] = [
  {
    slug: DEPT_HUB,
    kind: "location",
    ...
    related: [TOURS_HUB, "/permis-de-construire", "/dessinateur-batiment-joue-les-tours"],
  ...
  },
  {
    ...
    related: [DEPT_HUB, "/permis-de-construire", "/dessinateur-batiment-saint-cyr-sur-loire"],
    place: "Tours",
    placeType: "City",
    postalCode: "37100",
  },
  {
    ...
    related: [TOURS_HUB, DEPT_HUB, "/permis-de-construire"],
  ...
  },
  {
    ...
    related: [TOURS_HUB, "/accompagnement-projet-habitat", "/declaration-prealable"],
  ...
  },
  {
    ...
    related: [TOURS_HUB, "/declaration-prealable", "/plans-techniques"],
  ...
  },
  {
    ...
    related: [TOURS_HUB, "/permis-de-construire", "/rendus-photorealistes"],
  ...
  },
  {
    ...
    related: [TOURS_HUB, "/permis-de-construire", "/modelisation-3d"],
    place: "Veigné",
    placeType: "City",
    postalCode: "37250",
  },
  {
    ...
    related: [TOURS_HUB, "/declaration-prealable", "/accompagnement-projet-habitat"],
    place: "Esvres",
    placeType: "City",
    postalCode: "37320",
  },
...
export const DEDICATED_PAGES: DedicatedPage[] = [
  ...SERVICE_PAGES,
  ...LOCATION_PAGES,
];

export const DEDICATED_ROUTES: string[] = DEDICATED_PAGES.map((p) => p.slug);

export function getPageBySlug(slug: string): DedicatedPage | undefined {
  return DEDICATED_PAGES.find((p) => p.slug === slug);
}
